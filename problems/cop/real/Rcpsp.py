...
# a) using tuple unpacking allows us to get directly fields of the tuples. Instead, we could write:
...
# b) for posting Cumulative constraints in an alternative way, it would be less compact to write:
...
# c) in case of b), using zip is compacter than writing something like:
