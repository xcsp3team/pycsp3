...
def _extract_code(function_name):
    ...
    if sys.version_info[1] >= 8 and function_name not in ("Var", "VarArray", "VarArrayMultiple"):  # why special cases for Var and VarArray?
...
def extract_declaration_for(function_name):
    ...
    if function_name == "Var":
        ...
        return declaration
    elif function_name in ("VarArray", "VarArrayMultiple"):
